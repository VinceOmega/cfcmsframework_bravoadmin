...
<cfscript>
    ...
    lock scope="server" type="exclusive" timeout="5"{
        ...
        /*********************************************************************/
        server.pricesNotToShow          = this.configComponentsForServerVars.getPriceToNotShow();
        server.DNSPList                 = valuelist( server.pricesNotToShow.brandCode );
        /*********************************************************************/
        ...
        server.serverVariables          = this.configComponentsForServerVars.getServerVars( {} );
