<cfscript>
	...
	APPLICATION[ 'eclipseDatabase' ] 												= "eclipse";
	...
	/************************************************************************************************************************************************/
	APPLICATION[ 'SiteNameAndId' ] 							= this.configComponentsForAppVars.getAllSites();
	APPLICATION[ 'UserNameAndId' ] 							= this.configComponentsForAppVars.getAllUsers();
